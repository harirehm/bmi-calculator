...
<body>    
	...
	<c:if test="${bmi<18.5}">
		...
		<ul>
			<li class="lead"><a href="http://www.thehealthsite.com/fitness/weight-gain-foods-sa114/">Here are some <span class="text-danger">foods</span>  that will help you increase your weight.</a></li>
			<li class="lead"><a href="http://www.stylecraze.com/articles/effective-yoga-exercises-to-gain-weight/">These are some basic <span class="text-danger">exercises</span> that will help you increase your weight.</a></li>
		</ul>
	</c:if>
